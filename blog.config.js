...
const BLOG = {
  ...
  AUTHOR: 'horton', // 作者
  BIO: 'Hi！我是Horton，欢迎来到我的博客！！', // 作者简介
  LINK: 'https://hortonyyx.com', // 网站地址
  KEYWORDS: 'Notion, blog', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'hortonyyx@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/hortonyyx', // 你的github个人主页
  CONTACT_TELEGRAM: 'https://t.me/hortonyyx1', // 你的telegram 地址 例如 https://t.me/tangly_1024
